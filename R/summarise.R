...
#' @param interval Numeric value, giving the length of the computational
#'   interval in seconds.
#'
#' @export
...
#' @describeIn spiro_glance Method for constant load tests. Gives an average of
#'   all steps performed at the constant load.
#' @export
