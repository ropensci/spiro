...
Data over time (Panel 1,2,3,6,8,9) will be displayed as a smoothing average over an interval set in the `smooth` argument. The other panels (4,5,7) use the raw breath-by-breath data for visualization. 
